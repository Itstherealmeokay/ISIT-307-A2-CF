...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_location'])) {
    ...
    $sql = "INSERT INTO ChargingLocations (description, num_stations, cost_per_hour) 
            VALUES ('$description', '$num_stations', '$cost_per_hour')";

    if ($conn->query($sql) === TRUE) {
        echo "New charging location added successfully.";
    } else {
